...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=5381645912&password=MINISTER_C2WHEZ-BOSSQKREQP"
    elif r == "ME":
        return "uid=5625769690&password=35666428893C744422441A1AE51A04C4F60855EA8FA3E1F1391BA9BDE547A9BF"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=5119668284&password=57A9EF8FD80654681B3C6E806EB6CF94187D236A735DFF3AF0EBA638748EF5E0"
    else:
        return "uid=5183801566&password=STAR-5X4WTJD7V-CORE"
